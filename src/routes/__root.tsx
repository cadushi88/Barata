...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      { name: "theme-color", content: "#0a2540", media: "(prefers-color-scheme: light)" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Barlow:ital,wght@0,400;0,500;0,600;0,700;1,600&family=Oswald:wght@500;600;700&display=swap",
      },
    ],
  }),
